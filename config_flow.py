...
class AlarmoSiaOptionsFlow(config_entries.OptionsFlow):
    ...
    async def async_step_init(self, user_input=None):
        ...
        schema_dict[vol.Optional("key", default=current_key if current_key else "")] = str
        ...
        # 4. AC POWER MONITORING (FIX: Conditionally apply default to avoid UUID error)
